...
function createGrpcWebTransport(options) {
    ...
    return {
        ...
        async stream(service, method, signal, timeoutMs, header, input, contextValues) {
            var _a;
            const { serialize, parse } = (0, protocol_1.createClientMethodSerializers)(method, useBinaryFormat, options.jsonOptions, options.binaryOptions);
            function parseResponseBody(body, foundStatus, trailerTarget, header, headerError, signal) {
            ...
            return (0, protocol_1.runStreamingCall)({
                ...
                next: async (req) => {
                    ...
                    const res = Object.assign(Object.assign({}, req), { header: fRes.headers, trailer, message: parseResponseBody(fRes.body, foundStatus, trailer, fRes.headers, headerError, req.signal) });
                    return res;
                },
            });
        },
