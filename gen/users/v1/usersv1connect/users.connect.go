...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/az5840/connect-go-example/gen/users/v1"
...
type UsersServiceClient interface {
	...
	CreateUser(context.Context) *connect.ClientStreamForClient[v1.CreateUserRequest, emptypb.Empty]
	GetUsers(context.Context, *connect.Request[emptypb.Empty]) (*connect.ServerStreamForClient[v1.GetUsersResponse], error)
}
...
func NewUsersServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UsersServiceClient {
	...
	return &usersServiceClient{
		...
		createUser: connect.NewClient[v1.CreateUserRequest, emptypb.Empty](
			httpClient,
...
type usersServiceClient struct {
	...
	createUser *connect.Client[v1.CreateUserRequest, emptypb.Empty]
...
func (c *usersServiceClient) CreateUser(ctx context.Context) *connect.ClientStreamForClient[v1.CreateUserRequest, emptypb.Empty] {
	return c.createUser.CallClientStream(ctx)
}

// GetUsers calls users.v1.UsersService.GetUsers.
func (c *usersServiceClient) GetUsers(ctx context.Context, req *connect.Request[emptypb.Empty]) (*connect.ServerStreamForClient[v1.GetUsersResponse], error) {
...
type UsersServiceHandler interface {
	GetUser(context.Context, *connect.Request[v1.GetUserRequest]) (*connect.Response[v1.GetUserResponse], error)
	CreateUser(context.Context, *connect.ClientStream[v1.CreateUserRequest]) (*connect.Response[emptypb.Empty], error)
	GetUsers(context.Context, *connect.Request[emptypb.Empty], *connect.ServerStream[v1.GetUsersResponse]) error
}
...
func (UnimplementedUsersServiceHandler) CreateUser(context.Context, *connect.ClientStream[v1.CreateUserRequest]) (*connect.Response[emptypb.Empty], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("users.v1.UsersService.CreateUser is not implemented"))
}

func (UnimplementedUsersServiceHandler) GetUsers(context.Context, *connect.Request[emptypb.Empty], *connect.ServerStream[v1.GetUsersResponse]) error {
